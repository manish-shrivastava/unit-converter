...
#
#   UnitConverterClass.ratio(from, to)
...
# is a unit or alias created with BaseUnit or ConvertableUnit.  Unitnames may
# be separated by spaces or dashes.  Power on the unit defaults to 1.
# Author: Manish Shrivastava

module UnitConverterClass
public
...
private
  ...
  # between ^ and pwr.
  def UnitConverterClass.qty(m, s=nil)
    m,s = 1.0,m if s == nil
...
public
  # Return the ratio.
  def UnitConverterClass.ratio(top, bot)
    return UnitConverterClass.qty(top).ratio(UnitConverterClass.qty(bot))
  end
  ...
  class ConvertableUnit < Unit
    ...
    def initialize(name, measure)
      super(name)
      measure = UnitConverterClass.qty(measure) if measure.kind_of?(String)
      @related = measure
    end
    attr_reader :related
  end
...
private
  ...
  ConvertableUnit.new("kilometer", "1000 meter").alias("km")
  ConvertableUnit.new("centimeter", "0.01 meter").alias("cm")
  ConvertableUnit.new("milimeter", "0.01 meter").alias("mm")
  ConvertableUnit.new("inch", "2.54 cm").alias("in")
  ConvertableUnit.new("foot", "12 in").alias("ft", "feet")
  ConvertableUnit.new("mile", "5280 ft").alias("mi")
  ConvertableUnit.new("yard", "3 ft").alias("yd")
  ConvertableUnit.new("furlong", "660 ft")

  ConvertableUnit.new("milliliter", "cm^3").alias("ml", "cc")
  ConvertableUnit.new("liter", "1000 ml").alias("l")
  ConvertableUnit.new("gallon", "3.785412 liter").alias("gal")
  ConvertableUnit.new("quart", "0.25 gal").alias("qt")
  ConvertableUnit.new("pint", "0.5 quart").alias("pt")
  ConvertableUnit.new("cup", "0.25 quart")

  ConvertableUnit.new("acre", "43560 ft^2")
  ConvertableUnit.new("hectare", "10000 m^2")

  ConvertableUnit.new("minute", "60 sec").alias("min")
  ConvertableUnit.new("hour", "60 min").alias("hr")
  ConvertableUnit.new("day", "24 hr")
  ConvertableUnit.new("week", "7 day").alias("wk")
  ConvertableUnit.new("fortnight", "14 day")
  ConvertableUnit.new("year", "365.25 day").alias("yr")

  ConvertableUnit.new("kilogram", "1000 gram").alias("kg")
  ConvertableUnit.new("slug", "14.593903 kg")

  ConvertableUnit.new("newton", "kg-m/s^2").alias("N")
  ConvertableUnit.new("pound", "4.448222 N").alias("lb")

  ConvertableUnit.new("joule", "N-m").alias("J")
  ConvertableUnit.new("calorie", "0.238846 J").alias("cal")
  ConvertableUnit.new("kcal", "1000 cal")
  ConvertableUnit.new("BTU", "1055.055853 J")

  ConvertableUnit.new("watt", "J/s")
  ConvertableUnit.new("kilowatt", "1000 watt").alias("kw")
  ConvertableUnit.new("horsepower", "746 watt")

  ConvertableUnit.new("knot", "1.68781 ft/sec")
end